...
return [
    ...
    [
        ...
        'category_id' => [0],     // ID категорий из `/config/categories.php` (можно указывать через запятую внутри [], если товар находится в нескольких категориях одновременно) |Для навигации|
    ...
    // 500 монет
    [
        'name' => 'Ключ к кейсу с <br><b style="font-size: 25px;">привилегиями</b>',    // Название
        'price' => 850,     // Цена
    ...
    // 500 монет
    [
        'name' => 'Ключ к кейсу с <br><b style="font-size: 25px">мегакоинами</b>',    // Название
        'price' => 850,     // Цена
        'sale_price' => 1,  // Цена со скидкой
        'img' => [
            'default' => 'template/assets/images/case.png',    // URL картинки для отображения в списке товаров
